...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://drupal:Drupal@2017!@localhost/drupal?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://civi:Civi@2017!@localhost/civicrm?new_link=true');
  }
}
...
$civicrm_root = '/opt/compucorp.fusiondev.com.ar/web/drupal/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/opt/compucorp.fusiondev.com.ar/web/drupal/sites/default/files/civicrm/templates_c');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'https://compucorp.fusiondev.com.ar');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '45a5d8ccb14a7752b73c04cb20fb744e');
}
...
// define( 'CIVICRM_MAIL_LOG', '/opt/compucorp.fusiondev.com.ar/web/drupal/sites/default/files/civicrm/templates_c/mail.log');
// }
